...
#define	DTP_USER_ACCOUNTS				2								//用户帐号
#define	DTP_USER_PASS					3								//用户密码
#define DTP_USER_GENDER					4								//用户性别
#define DTP_USER_FACE					5								//用户头像
#define DTP_USER_RIGHT					6								//用户权限
#define DTP_MASTER_RIGHT				7								//管理权限
