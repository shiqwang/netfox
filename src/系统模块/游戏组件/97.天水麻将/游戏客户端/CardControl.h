...
protected:
	...
	enDirection						m_CardDirection;					//麻将方向
...
protected:
	...
	//麻将数据
protected:
	WORD							m_wCardCount;						//麻将数目
	BYTE							m_cbCardData[4];					//麻将数据
...
protected:
	...
	tagCardItem						m_CurrentCard;						//当前麻将
	tagCardItem						m_CardItemArray[13];				//麻将数据
...
//变量声明
extern CCardResource				g_CardResource;						//麻将资源
