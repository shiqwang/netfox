#ifndef CLIENT_NEW_KERNEL_SINK_HEAD_FILE
#define CLIENT_NEW_KERNEL_SINK_HEAD_FILE
...
class CClientKernelSink : public IClientKernelSink
{
	//变量定义
protected:
	CGameParrentDlg				& m_GameFrameDlg;						//游戏框架

	//函数定义
public:
	//构造函数
	CClientKernelSink(CGameParrentDlg & GameFrameDlg);
	//析构函数
