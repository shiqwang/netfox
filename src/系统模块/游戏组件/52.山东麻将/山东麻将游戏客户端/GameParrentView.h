#ifndef GAME_PARRENT_VIEW_HEAD_FILE
#define GAME_PARRENT_VIEW_HEAD_FILE
...
//游戏视图框架
class CGameParrentView : public CWnd, public IGameFrameView
{
	//友元定义
...
public:
	//构造函数
	CGameParrentView(bool bDoubleBuf=true ,UINT uColorCount=16, CThreadDraw * pThreadDraw=NULL);
	//析构函数
	virtual ~CGameParrentView();
...
public:
	...
	//是否有效
	virtual bool __cdecl IsValid() { return AfxIsValidAddress(this,sizeof(CGameParrentView))?true:false; }
	//接口查询
