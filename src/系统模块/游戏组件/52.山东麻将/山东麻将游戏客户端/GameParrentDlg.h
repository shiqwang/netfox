#ifndef GAME_PARRENT_DLG_HEAD_FILE
#define GAME_PARRENT_DLG_HEAD_FILE
...
//游戏主窗口
class CGameParrentDlg : public CDialog, public ISplitterSink
{ 
	//友元定义
...
protected:
	...
	CGameParrentView					* m_pGameFrameView;				//视图指针
...
public:
	//构造函数
	CGameParrentDlg(CGameParrentView * pGameFrameView);
	//析构函数
	virtual ~CGameParrentDlg();
