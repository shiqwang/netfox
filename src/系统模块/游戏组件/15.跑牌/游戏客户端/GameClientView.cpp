...
void CGameClientView::RectifyGameView(int nWidth, int nHeight)
{
	...
	DeferWindowPos(hDwp,m_btOutCard,NULL,nWidth/2-rcButton.Width()*3/2-30,nHeight-200-m_nYBorder,0,0,uFlags);
	DeferWindowPos(hDwp,m_btOutPrompt,NULL,nWidth/2-rcButton.Width()/2,nHeight-200-m_nYBorder,0,0,uFlags);
	DeferWindowPos(hDwp,m_btPassCard,NULL,nWidth/2+rcButton.Width()/2+30,nHeight-200-m_nYBorder,0,0,uFlags);
