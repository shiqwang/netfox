...
struct tagAnalyseResult
{
	...
	BYTE							m_bSCardData[16];					//手上扑克
	BYTE							m_bDCardData[16];					//手上扑克
	BYTE							m_bTCardData[16];					//手上扑克
	BYTE							m_bFCardData[16];					//手上扑克
};
...
public:
	...
	//是否有2
	bool IsCardTwoOwner(const BYTE bCardList[],BYTE bCardCount);
