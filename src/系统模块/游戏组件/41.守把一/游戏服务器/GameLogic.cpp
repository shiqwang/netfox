...
//			if ((AnalyseResult.bFourCount==1)&&(bCardCount==5)) return CT_FOUR_LINE_TAKE_ONE;
			if ((AnalyseResult.bFourCount==1)&&(AnalyseResult.bDoubleCount==1)&&(bCardCount==6)) return CT_FOUR_LINE_TAKE_DOUBLE;
...
//是否有牌2
bool CGameLogic::IsCardTwoOwner(const BYTE bCardList[],BYTE bCardCount)
{
