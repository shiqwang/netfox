...
void CGameClientView::RectifyGameView(int nWidth, int nHeight)
{
	...
	//玩家麻将区
	m_ptFaceMj[0].x  = nWidth/3+10;
	m_ptFaceMj[0].y  = m_ptFace[0].y+m_nYFace+REVISE_MJ_FACE;
	m_ptTouchMjs[0].x = nWidth/3-10;
	m_ptTouchMjs[0].y = m_ptFaceMj[0].y+m_csFaceMj[0].cy+REVISE_MJ_FACE;
	m_ptOutMjs[0].x   = nWidth/3;
	m_ptOutMjs[0].y   = m_ptTouchMjs[0].y+REVISE_MJ_FACE+20;
	...
	m_ptOutMjs[2].x=m_ptFaceMj[2].x+150;
	m_ptOutMjs[2].y=m_ptTouchMjs[2].y-REVISE_MJ_FACE*2-40;
