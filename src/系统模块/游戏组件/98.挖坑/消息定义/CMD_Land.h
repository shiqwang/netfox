...
#define KIND_ID						ID_WAKEN							//游戏 I D
#define GAME_PLAYER					3									//游戏人数
#define GAME_NAME					TEXT("挖坑")						//游戏名字
#define GAME_GENRE					(GAME_GENRE_SCORE|GAME_GENRE_GOLD)	//游戏类型

//Add by 20071129
#define LEFT_CARD_NUM	4 //留牌
#define ONE_USER_GET_CARD_NUM	16//每人得牌
#define ZHUANG_CARD_NUM   (LEFT_CARD_NUM+ONE_USER_GET_CARD_NUM)       //庄家牌数
#define ALL_CARD_NUM    (ONE_USER_GET_CARD_NUM*GAME_PLAYER + LEFT_CARD_NUM)//总牌数 52
