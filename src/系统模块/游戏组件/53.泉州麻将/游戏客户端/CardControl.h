...
//扑克定义
#define INSIDE_HEAP_FULL_COUNT				16							//内堆扑克
#define OUTSIDE_HEAP_FULL_COUNT				20							//外堆扑克	
#define SIDE_COUNT							4							//边堆扑克
...
public:
	...
	CCardListImage					m_ImageGoldBottom;					//图片资源
...
public:
	...
	//边堆扑克
public:
	CSkinImage						m_ImageSparrow_45;					//图片资源
	CSkinImage						m_ImageSparrow_135;					//图片资源
...
protected:
	...
	enArrangeMode					m_ArrangeMode;						//堆立方式
...
protected:
	...
	WORD							m_wMinusMiddlePos[20];				//中部空缺
...
public:
	...
	//排列方式
	void SetArrangeMode(enArrangeMode ArrangeMode)
	{
...
protected:
	...
	tagCardItem						m_CardItemArray[17];				//扑克数据
...
public:
	...
	//设置扑克
	bool SetCardData(const BYTE cbCardData[], WORD wCardCount, BYTE cbCurrentCard,BYTE cbGoldCard[],BYTE cbGoldCount);
	//设置扑克
