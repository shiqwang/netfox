...
CGameServiceManager::CGameServiceManager(void)
{
	...
	_tcscpy(szCurrencyDB,"KYGameDB");
	lstrcpyn(m_GameServiceAttrib.szDataBaseName,szCurrencyDB,CountArray(m_GameServiceAttrib.szDataBaseName));
#ifdef _TWICE
	lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("跑得快（两副牌）游戏服务组件"),CountArray(m_GameServiceAttrib.szDescription));
...
#else
	lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("跑得快游戏服务组件"),CountArray(m_GameServiceAttrib.szDescription));
