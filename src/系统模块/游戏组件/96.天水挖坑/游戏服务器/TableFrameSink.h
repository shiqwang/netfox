...
protected:
	...
	BYTE							m_bScoreInfo[GAME_PLAYER/*3*/];					//叫分信息
...
protected:
	...
	//扑克信息
protected:
	BYTE							m_bBackCard[LEFT_CARD_NUM/*3*/];						//游戏底牌
	BYTE							m_bCardCount[GAME_PLAYER/*3*/];					//扑克数目
	BYTE							m_bOutCardCount[GAME_PLAYER/*3*/];					//出牌次数
	BYTE							m_bHandCardData[GAME_PLAYER/*3*/][ZHUANG_CARD_NUM /*20*/];				//手上扑克
