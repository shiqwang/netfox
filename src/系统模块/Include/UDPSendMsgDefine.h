...
#define 	CMD_SEND_NET_TEST	5//	网络测试命令
#define 	CMD_SEND_NET_TEST_BAK	6//	网络测试命令回应
#define 	CMD_SEND_NET_P2PTRANS	7//	服务器接收
#define 	CMD_SEND_NET_P2PSOMEONEWANTTOCALLYOU	8//	对方想CALL你
#define 	CMD_SEND_NET_P2PTRASH	9//	P2P回应
...
#define MAX_UDP_SIZE   1024*4 //1024*8   //太小会产生马赛克