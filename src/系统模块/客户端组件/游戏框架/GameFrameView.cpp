	...
	: m_bDoubleBuf(bDoubleBuf), m_uColorCount(uColorCount), m_pThreadDraw(pThreadDraw)
{
	...
	m_PicVideo.SetLoadInfo(IDB_VIDEO_PIC,hInstance);
	m_PicMyselfVideo.SetLoadInfo(IDB_MYSELF_VIDEO_PIC,hInstance);
	m_PicOpBak.SetLoadInfo(IDB_OP_BAK,hInstance);
...
void CGameFrameView::DrawUserReady(CDC * pDC, int nXPos, int nYPos)
{
	...
	//画op back标志
void CGameFrameView::DrawOtherOpBackPic(CDC * pDC, int nXPos, int nYPos)
{
	CImageHandle ImageHandle(&m_PicOpBak);
	int nImageWidth=ImageHandle->GetWidth();
	int nImageHeight=ImageHandle->GetHeight();
//	AlphaDrawImage(pDC,nXPos-nImageWidth/2,nYPos-nImageHeight/2,nImageWidth,nImageHeight,ImageHandle.GetBitmapHandle(),0,0,RGB(255,0,255));
	AlphaDrawImage(pDC,nXPos,nYPos,nImageWidth,nImageHeight,ImageHandle.GetBitmapHandle(),0,0,RGB(255,0,255));

	return;

}
	//画self video标志
void CGameFrameView::DrawMyselfVideoPic(CDC * pDC, int nXPos, int nYPos)
{
	CImageHandle ImageHandle(&m_PicMyselfVideo);
	int nImageWidth=ImageHandle->GetWidth();
	int nImageHeight=ImageHandle->GetHeight();
//	AlphaDrawImage(pDC,nXPos-nImageWidth/2,nYPos-nImageHeight/2,nImageWidth,nImageHeight,ImageHandle.GetBitmapHandle(),0,0,RGB(255,0,255));
	AlphaDrawImage(pDC,nXPos,nYPos,nImageWidth,nImageHeight,ImageHandle.GetBitmapHandle(),0,0,RGB(255,0,255));
...
//画video标志
void CGameFrameView::DrawOtherVideoPic(CDC * pDC, int nXPos, int nYPos)
{
	CImageHandle ImageHandle(&m_PicVideo);
	int nImageWidth=ImageHandle->GetWidth();
	int nImageHeight=ImageHandle->GetHeight();
//	AlphaDrawImage(pDC,nXPos-nImageWidth/2,nYPos-nImageHeight/2,nImageWidth,nImageHeight,ImageHandle.GetBitmapHandle(),0,0,RGB(255,0,255));
	AlphaDrawImage(pDC,nXPos,nYPos,nImageWidth,nImageHeight,ImageHandle.GetBitmapHandle(),0,0,RGB(255,0,255));
...
bool CGameFrameView::DrawGameViewFrame(CDC * pDC, int nWidth, int nHeight)
{
	...
	int iXPos=nWidth-30;
	int iYPos=5;
	DrawOtherOpBackPic( pDC,  iXPos,  iYPos);
